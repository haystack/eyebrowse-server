...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tags_vote', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Comment'], null=True))
    ...
    models = {
        ...
        'tags.tag': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'comments': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['api.Comment']", 'symmetrical': 'False'}),
