...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tag.comment'
        db.alter_column('tags_tag', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.EyeHistoryMessage'], null=True))

    def backwards(self, orm):

        # Changing field 'Tag.comment'
        db.alter_column('tags_tag', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['api.EyeHistoryMessage']))
