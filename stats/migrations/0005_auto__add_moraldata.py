...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MoralData'
        db.create_table('stats_moraldata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('authority', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('loyalty', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('care', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('fairness', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('purity', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('stats', ['MoralData'])


    def backwards(self, orm):
        # Deleting model 'MoralData'
        db.delete_table('stats_moraldata')
