...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MoralData.is_treatment'
        db.add_column('stats_moraldata', 'is_treatment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MoralData.is_treatment'
        db.delete_column('stats_moraldata', 'is_treatment')
