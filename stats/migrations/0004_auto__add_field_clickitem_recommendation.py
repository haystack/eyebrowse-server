...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClickItem.recommendation'
        db.add_column('stats_clickitem', 'recommendation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClickItem.recommendation'
        db.delete_column('stats_clickitem', 'recommendation')
