...
#     user = models.ForeignKey(User,related_name='topic_content_type')
...
#         content = email_templates.alt_email['content'] % (self.user.first_name, self.email, settings.BASE_URL + '/confirm_email/' + self.activation_key + '/')
...
#     def __unicode__(self):
#         return "%s, confirmed: %s, owned by %s" % (self.email, self.confirmed, self.user.username)
