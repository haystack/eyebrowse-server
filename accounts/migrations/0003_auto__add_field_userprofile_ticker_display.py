...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.ticker_display'
        db.add_column('accounts_userprofile', 'ticker_display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.ticker_display'
        db.delete_column('accounts_userprofile', 'ticker_display')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'ticker_display': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
