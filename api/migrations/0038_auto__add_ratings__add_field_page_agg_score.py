...
class Migration(SchemaMigration):
    ...
    models = {
        'api.blacklistitem': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 4, 16, 0, 0)'}),
