...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('api_page', 'url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.url'
        db.alter_column('api_page', 'url', self.gf('django.db.models.fields.URLField')(max_length=300))

    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 6, 0, 0)'}),
