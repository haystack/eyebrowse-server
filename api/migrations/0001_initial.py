...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_whitelistitem', (
            ('filterlistitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['api.FilterListItem'], unique=True, primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='whitelist', max_length=40)),
        ))
        ...
        db.create_table('api_blacklistitem', (
            ('filterlistitem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['api.FilterListItem'], unique=True, primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='blacklist', max_length=40)),
        ))
