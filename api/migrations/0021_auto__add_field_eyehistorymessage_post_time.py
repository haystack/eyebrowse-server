...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EyeHistoryMessage.post_time'
        db.add_column('api_eyehistorymessage', 'post_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EyeHistoryMessage.post_time'
        db.delete_column('api_eyehistorymessage', 'post_time')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)'}),
