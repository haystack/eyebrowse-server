...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('api_eyehistorymessage', 'parent_comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Comment'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('api_eyehistorymessage', 'parent_comment_id')
    ...
    models = {
        'api.blacklistitem': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 8, 19, 0, 0)'}),
