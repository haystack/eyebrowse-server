...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PopularHistory.humanize_avg_time'
        db.add_column('api_popularhistory', 'humanize_avg_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'PopularHistory.avg_time_ago'
        db.add_column('api_popularhistory', 'avg_time_ago',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 2, 26, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PopularHistory.humanize_avg_time'
        db.delete_column('api_popularhistory', 'humanize_avg_time')

        # Deleting field 'PopularHistory.avg_time_ago'
        db.delete_column('api_popularhistory', 'avg_time_ago')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 26, 0, 0)'}),
