...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EyeHistoryRaw.favicon_url'
        db.add_column('api_eyehistoryraw', 'favicon_url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PopularHistoryInfo.favicon_url'
        db.add_column('api_popularhistoryinfo', 'favicon_url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'EyeHistory.favicon_url'
        db.add_column('api_eyehistory', 'favicon_url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EyeHistoryRaw.favicon_url'
        db.delete_column('api_eyehistoryraw', 'favicon_url')

        # Deleting field 'PopularHistoryInfo.favicon_url'
        db.delete_column('api_popularhistoryinfo', 'favicon_url')

        # Deleting field 'EyeHistory.favicon_url'
        db.delete_column('api_eyehistory', 'favicon_url')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 12, 0, 0)'}),
