...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonalizedRatings'
        db.create_table('api_personalizedratings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Page'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('api', ['PersonalizedRatings'])

        # Adding unique constraint on 'PersonalizedRatings', fields ['user', 'page']
        db.create_unique('api_personalizedratings', ['user_id', 'page_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PersonalizedRatings', fields ['user', 'page']
        db.delete_unique('api_personalizedratings', ['user_id', 'page_id'])

        # Deleting model 'PersonalizedRatings'
        db.delete_table('api_personalizedratings')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 5, 19, 0, 0)'}),
