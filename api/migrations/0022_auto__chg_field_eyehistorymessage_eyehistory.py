...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('api_eyehistorymessage', 'eyehistory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.EyeHistory'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'EyeHistoryMessage.eyehistory'
        db.alter_column('api_eyehistorymessage', 'eyehistory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.EyeHistory']))

    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 18, 0, 0)'}),
