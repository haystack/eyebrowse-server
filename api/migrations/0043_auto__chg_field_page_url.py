...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('api_page', 'url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Page.url'
        db.alter_column('api_page', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=2000))
    ...
    models = {
        ...
        'api.page': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2000'}),
            'url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '2000', 'null': 'True'})
        },
        'api.popularhistory': {
