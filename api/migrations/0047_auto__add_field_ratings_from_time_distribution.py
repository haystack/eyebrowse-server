...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ratings.from_time_distribution'
        db.add_column('api_ratings', 'from_time_distribution',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ratings.from_time_distribution'
        db.delete_column('api_ratings', 'from_time_distribution')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 5, 12, 0, 0)'}),
