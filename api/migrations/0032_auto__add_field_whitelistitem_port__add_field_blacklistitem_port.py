...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WhiteListItem.port'
        db.add_column('api_whitelistitem', 'port',
                      self.gf('django.db.models.fields.IntegerField')(default=80),
                      keep_default=False)

        # Adding field 'BlackListItem.port'
        db.add_column('api_blacklistitem', 'port',
                      self.gf('django.db.models.fields.IntegerField')(default=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WhiteListItem.port'
        db.delete_column('api_whitelistitem', 'port')

        # Deleting field 'BlackListItem.port'
        db.delete_column('api_blacklistitem', 'port')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 20, 0, 0)'}),
