...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChatMessage.to_user'
        db.delete_column('api_chatmessage', 'to_user_id')
    ...
    def backwards(self, orm):
        # Adding field 'ChatMessage.to_user'
        db.add_column('api_chatmessage', 'to_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='to_user', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ChatMessage.read'
        db.add_column('api_chatmessage', 'read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        db.rename_column('api_chatmessage', 'author_id', 'from_user_id')


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
