...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Domain.url'
        db.alter_column('api_domain', 'url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200))
        # Adding unique constraint on 'Domain', fields ['url']
        db.create_unique('api_domain', ['url'])


    def backwards(self, orm):
        # Removing unique constraint on 'Domain', fields ['url']
        db.delete_unique('api_domain', ['url'])


        # Changing field 'Domain.url'
        db.alter_column('api_domain', 'url', self.gf('django.db.models.fields.URLField')(max_length=300))

    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 5, 1, 0, 0)'}),
