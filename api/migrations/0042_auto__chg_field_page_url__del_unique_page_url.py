...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
       ...
       # db.delete_unique('api_page', ['url'])


        # Changing field 'Page.url'
        db.alter_column('api_page', 'url', self.gf('django.db.models.fields.URLField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Page.url'
        db.alter_column('api_page', 'url', self.gf('django.db.models.fields.TextField')(unique=True))
        # Adding unique constraint on 'Page', fields ['url']
        db.create_unique('api_page', ['url'])
