...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('api_whitelistitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'BlackListItem.url'
        db.alter_column('api_blacklistitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'WhiteListItem.url'
        db.alter_column('api_whitelistitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=100))

        # Changing field 'BlackListItem.url'
        db.alter_column('api_blacklistitem', 'url', self.gf('django.db.models.fields.URLField')(max_length=100))
