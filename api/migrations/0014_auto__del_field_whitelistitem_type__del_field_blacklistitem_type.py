...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WhiteListItem.type'
        db.delete_column('api_whitelistitem', 'type')

        # Deleting field 'BlackListItem.type'
        db.delete_column('api_blacklistitem', 'type')


    def backwards(self, orm):
        # Adding field 'WhiteListItem.type'
        db.add_column('api_whitelistitem', 'type',
                      self.gf('django.db.models.fields.CharField')(default='whitelist', max_length=40),
                      keep_default=False)

        # Adding field 'BlackListItem.type'
        db.add_column('api_blacklistitem', 'type',
                      self.gf('django.db.models.fields.CharField')(default='blacklist', max_length=40),
                      keep_default=False)
