...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EyeHistoryMessage', fields ['eyehistory']
        db.delete_unique('api_eyehistorymessage', ['eyehistory_id'])


        # Changing field 'EyeHistoryMessage.eyehistory'
        db.alter_column('api_eyehistorymessage', 'eyehistory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.EyeHistory']))

    def backwards(self, orm):

        # Changing field 'EyeHistoryMessage.eyehistory'
        db.alter_column('api_eyehistorymessage', 'eyehistory_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['api.EyeHistory'], unique=True))
        # Adding unique constraint on 'EyeHistoryMessage', fields ['eyehistory']
        db.create_unique('api_eyehistorymessage', ['eyehistory_id'])


    models = {
        'api.blacklistitem': {
            'Meta': {'unique_together': "(('user', 'url'),)", 'object_name': 'BlackListItem'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 19, 0, 0)'}),
        ...
        'api.eyehistorymessage': {
            'Meta': {'object_name': 'EyeHistoryMessage'},
            'eyehistory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['api.EyeHistory']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
