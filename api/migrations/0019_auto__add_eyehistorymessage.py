...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_eyehistorymessage', (
            ...
            ('eyehistory', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['api.EyeHistory'], unique=True)),
        ))
    ...
    models = {
        'api.blacklistitem': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 18, 0, 0)'}),
        ...
        'api.eyehistorymessage': {
            ...
            'eyehistory': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['api.EyeHistory']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
