...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_mutelist', (
            ...
            ('domain', self.gf('django.db.models.fields.URLField')(max_length=300)),
        ))
    ...
    models = {
        'api.blacklistitem': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 28, 0, 0)'}),
        ...
        'api.mutelist': {
            ...
            'domain': ('django.db.models.fields.URLField', [], {'max_length': '300'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'api.popularhistory': {
