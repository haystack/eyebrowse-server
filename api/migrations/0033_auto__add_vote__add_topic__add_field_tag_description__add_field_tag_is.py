...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_vote', (
            ...
            ('value_tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Tag'])),
    ...
    models = {
        'api.blacklistitem': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 15, 0, 0)'}),
