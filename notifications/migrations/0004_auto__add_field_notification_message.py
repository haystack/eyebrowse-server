...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notifications_notification', 'message',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('notifications_notification', 'message')
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
